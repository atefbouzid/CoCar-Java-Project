...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <header>Modification de profile</header>
      <form action="settingb.jsp">
        ...
        <div class="fields">
          ...
          <div class="input-field">
            ...
            <input
              type="text"
              name="email"
              placeholder="Exemple : flenfoulani@gmail.com"
              required
            />
          </div>
        ...
        <div class="details ID">
          <span class="title">Changement de mot de passe</span>
          <div class="fields">
            <div class="input-field">
